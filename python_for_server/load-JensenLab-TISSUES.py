...
Usage:
    load-JensenLab-TISSUES.py [--debug | --quiet] [--dbhost=<str>] [--dbname=<str>] [--pwfile=<str>] [--dbuser=<str>] [--logfile=<file>] [--loglevel=<int>] [--datalevel=<int>]
    load-JensenLab-TISSUES.py -? | --help
