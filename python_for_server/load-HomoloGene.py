...
if __name__ == '__main__':
    ...
    dataset_id = dba.ins_dataset( {'name': 'HomoloGene', 'source': "File ftp://ftp.ncbi.nih.gov/pub/HomoloGene/current/homologene.txt", 'app': PROGRAM, 'app_version': __version__, 'url': 'https://www.ncbi.nlm.nih.gov/homologene','comment':'Only Human, Mouse and Rat members of HomoloGene groups are loaded. These relate protein to nhprotein.'} )
