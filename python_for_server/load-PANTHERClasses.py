...
Usage:
    load-PANTHERClasses.py [--debug | --quiet] [--dbhost=<str>] [--dbname=<str>] [--pwfile=<str>] [--dbuser=<str>] [--logfile=<file>] [--loglevel=<int>]
    load-PANTHERClasses.py -? | --help
...
P2PC_FILE = '../data/PANTHER/PTHR18.0_humant.txt'
