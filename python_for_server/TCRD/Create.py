  ...
  def ins_clinvar(self,init):
    ...
    with closing(self._conn.cursor()) as curs:
      try:
        ...
        self._logger.error(f"MySQL Error in ins_clinvar(): {e}")
        self._logger.error(f"SQLpat: {sql}")
        self._logger.error(f"SQLparams: {params}")
        self._conn.rollback()
        return False
  ...
  def ins_clinvar_phenotype_xref(self,init):
    ...
    with closing(self._conn.cursor()) as curs:
      try:
        ...
        self._logger.error(f"MySQL Error in ins_clinvar_phenotype_xref(): {e}")
        self._logger.error(f"SQLpat: {sql}")
        self._logger.error(f"SQLparams: {params}")
        self._conn.rollback()
        return False
  ...
  def ins_clinvar_phenotype(self,init):
    ...
    with closing(self._conn.cursor()) as curs:
      try:
        ...
        #print(e)
        #print(sql)
        self._logger.error(f"MySQL Error in ins_clinvar_phenotype(): {e}")
        self._logger.error(f"SQLpat: {sql}")
        self._conn.rollback()
        return False
    return cvpt_id
