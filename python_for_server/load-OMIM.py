...
if __name__ == '__main__':
    ...
    dataset_id = dba.ins_dataset( {'name': 'OMIM', 'source': "NULL", 'app': PROGRAM, 'app_version': __version__, 'url': 'http://omim.org/'} )
    assert dataset_id ,f"Error inserting data, for more infor see logfile:{logfile}"
    provs = [ {'dataset_id': dataset_id, 'table_name': 'disease','where_clause':"dtype = 'eRAM'"}]
    for prov in provs:
