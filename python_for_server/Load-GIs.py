...
Usage:
    load-GIs.py [--debug | --quiet] [--dbhost=<str>] [--dbname=<str>] [--pwfile=<str>] [--dbuser=<str>] [--logfile=<file>] [--loglevel=<int>]
    load-GIs.py -? | --help
...
def download(args):
    gzfn = os.path.join(DOWNLOAD_DIR, FILENAME)
